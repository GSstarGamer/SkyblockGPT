...
function requireContainerId(url) {
...
function readIntegerParameter(url, name, fallback, minimum, maximum) {
...
function readTextParameter(url, name, maximum, fallback = "") {
...
function requireEnumParameter(url, name, allowed, fallback = null) {
...
function readOptionalBooleanParameter(url, name) {
  const raw = url.searchParams.get(name);
